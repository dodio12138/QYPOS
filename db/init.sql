...
CREATE INDEX online_order_inbox_received_idx ON online_order_inbox(received_at DESC);
CREATE INDEX online_order_inbox_status_idx ON online_order_inbox(status, updated_at DESC);
...
CREATE INDEX online_order_inbox_items_order_idx ON online_order_inbox_items(inbox_order_id);
